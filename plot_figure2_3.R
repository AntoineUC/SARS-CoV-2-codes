...
plot(vecgammacovid~vecucovid,type="l",xlab="Threshold",ylab="xi",main="SARS-CoV-2 clusters in Italy",ylim=c(-1,3),xlim=c(1,100),col="red")
...
plot(vecgammacovid~vecucovid,type="l",xlab="Threshold",ylab="xi",main="SARS-CoV-2 clusters in Kerala",ylim=c(-1,3),xlim=c(1,100),col="red")
...
Ynj=Y[which(californiaindex==1)]

points(longitude[which(californiaindex==1)],latitude[which(californiaindex==1)],cex=5*Ynj/max(Ynj),col="red")
...
plot(vecgammacovid~vecucovid,type="l",xlab="Threshold",ylab="xi",main="SARS-CoV-2 clusters in New Jersey",ylim=c(-1,3),xlim=c(0,250),col="red")

points(vecgammainfcovid~vecucovid,type="l",lty=3,col="red")

points(vecgammasupcovid~vecucovid,type="l",lty=3,col="red")

abline(a=0.2,b=0,col="red",lty=5)

abline(v=75,col="blue",lty=5)
