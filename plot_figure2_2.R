...
plot(vecgammacovid~vecucovid,type="l",xlab="Threshold",ylab="xi",main="SARS-CoV-2 clusters in China",ylim=c(-1,3),xlim=c(1,50),col="red")
...
californiaindex=(latitude<=41)*(latitude>37)*(longitude<=-102)*(longitude>-109)

Ycolorado=Y[which(californiaindex==1)]

points(longitude[which(californiaindex==1)],latitude[which(californiaindex==1)],cex=5*Ycolorado/max(Ycolorado),col="red")
...
plot(vecgammacovid~vecucovid,type="l",xlab="Threshold",ylab="xi",main="SARS-CoV-2 clusters in Colorado",ylim=c(-1,3),xlim=c(0,150),col="red")

points(vecgammainfcovid~vecucovid,type="l",lty=3,col="red")

points(vecgammasupcovid~vecucovid,type="l",lty=3,col="red")

abline(a=0.9,b=0,col="red",lty=5)
...
plot(vecgammacovid~vecucovid,type="l",xlab="Threshold",ylab="xi",main="SARS-CoV-2 clusters in France",ylim=c(-1,3),xlim=c(1,75),col="red")
...
vecquant=1-(1+vecgamma[8]*((1:10000)+1)/vecsigma[8])^(-1/vecgamma[8])

quantau=26+which(vecquant>=tau)[1]
